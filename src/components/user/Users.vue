  ...
  <div>
    ...
    >
      <div>
        ...
        <p style="text-align:left">当前的角色 {{ userInfo.role_name }}</p>
...
export default {
  data() {
    ...
    var checkMobile = (rule, value, cb) => {
      // 验证手机号的正则表达式
      const regEmail = /^(0|86|17951)?(16[6]|13[0-9]|15[0123456789]|17[3678]|18[0-9]|14[57])[0-9]{8}$/
      if (regEmail.test(value)) {
        return cb()
      }
